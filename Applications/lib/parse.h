...
extern void StartEchoWhenAddressed(FILE *uart, char address);
extern void AssembleCommand(FILE *uart);
extern uint8_t findArgument(FILE *uart, uint8_t at_command_buf_offset);
extern uint8_t findCommand(FILE *uart);
extern unsigned long is_arg_in_ul_range (FILE *uart, uint8_t arg_num, unsigned long min, unsigned long max);
extern uint8_t is_arg_in_uint8_range (FILE *uart, uint8_t arg_num, uint8_t min, uint8_t max);
